package org.hycode.h2holer.server.services.workers;

import org.hycode.h2holer.common.workers.ThreadPoolFactory;
import org.hycode.h2holer.server.services.handlers.ClientAuthCheckHandler;
import org.hycode.h2holer.server.services.handlers.ClientIntraHandler;
...
public class WorkerGroup {
    ...
    private final int MAX_WORKER = 5;
    private int i = 0;

    public WorkerGroup() {
        clientHandleWorkers = new LinkedList<>();
        pool = new ThreadPoolExecutor(MAX_WORKER, MAX_WORKER, 0L, TimeUnit.MILLISECONDS,
    ...
    private void initializer() {
        for (int i = 0; i < MAX_WORKER; i++) {
             ...
             * 临时
             */
            clientHandleWorker.addHandler(new ClientAuthCheckHandler());
